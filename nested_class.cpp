...
//  add one more derived class to current account to inherits the property and add a
// property of OD (over draft)
...
public:
    ...
    */
    ...
    class current_account :public BankAccount {
private:
    double over_draft;

public:
    current_account (double od)
    {
        over_draft=od;
    }
    ...
    void display()
    {
        cout<<"over draft amount"over_draft<<endl;
    }
